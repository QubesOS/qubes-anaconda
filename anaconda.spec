...
Patch0001: 0001-add-Qubes-post-scripts.patch
Patch0002: 0002-remove-other-installclasses.patch
Patch0003: 0003-Disable-network-by-ignoring-any-present-nic.patch
Patch0004: 0004-remove-network-setup-from-graphical-and-text-interfa.patch
Patch0005: 0005-fix-grub-config-setup-by-removing-non-xen-options.patch
Patch0006: 0006-set-default-grub-theme.patch
Patch0007: 0007-add-options-can_dual_boot-and-can_update-to-grub.patch
Patch0008: 0008-efimgr-specify-root-util.getSysroot.patch
Patch0009: 0009-fix-dracut-module-to-work-with-reduced-dependencies.patch
Patch0010: 0010-use-installer-kernel-parameters-as-default-for-insta.patch
Patch0011: 0011-use-kernel-install-instead-of-grubby-to-regenerate-i.patch
#Patch0012: 0012-Fix-a-regular-expression-determining-Release.patch
Patch0013: 0013-Do-not-fail-during-initramfs-start-up-due-to-missing.patch
Patch0014: 0014-Disable-the-NTP-configuration-spoke.patch
Patch0015: 0015-drop-useless-on-Qubes-dependencies-on-network-filesy.patch
Patch0016: 0016-add-skip_grub-parameter-and-allow-boot-encryption-an.patch
Patch0017: 0017-add-console-none-Xen-parameter.patch
Patch0018: 0018-add-dom0_mem-min-1024M-to-default-xen-cmdline.patch
Patch0019: 0019-limit-dom0-maxmem-to-4GB-to-limit-its-overhead-on-bi.patch
Patch0020: 0020-disable-iommu-for-IGFX.patch
Patch0021: 0021-check-for-Qubes-OS-hardware-required-features.patch
Patch0022: 0022-generate-proper-extlinux.conf.patch
Patch0023: 0023-don-t-crash-when-no-target-disk-is-available.patch
Patch0024: 0024-Modify-user-configuration-spoke-for-QubesOS.patch
Patch0025: 0025-Make-sure-that-a-user-is-created-at-installation-tim.patch
Patch0026: 0026-check-add-user-to-wheel-and-qubes-groups.patch
Patch0027: 0027-fix-default-scheme-in-custom-partitioning.patch
Patch0028: 0028-enable-discard-option-for-dom0-filesystems-by-defaul.patch
Patch0029: 0029-Add-ucode-scan-to-default-Xen-command-line.patch
Patch0030: 0030-avoid-adding-duplicated-kernel-entries.patch
Patch0031: 0031-mark-qubes-user-name-as-reserved.patch
Patch0032: 0032-add-smt-off-xen-option-during-installation.patch
Patch0033: 0033-update-Qubes-specific-code-for-Fedora-21-version.patch
Patch0034: 0034-abort-installation-on-X-startup-fail.patch
Patch0035: 0035-fix-encryption-passphrase-check.patch
Patch0036: 0036-disable-os-prober.patch
Patch0037: 0037-add-option-to-lock-root-account.patch
