...
Patch0: 0001-anaconda-add-Qubes-installclass.patch
Patch1: 0002-anaconda-add-Qubes-post-scripts.patch
Patch2: 0003-anaconda-remove-other-installclasses.patch
Patch3: 0004-anaconda-do-not-start-network-during-install-set-def.patch
Patch4: 0005-anaconda-remove-network-setup-from-text-interface.patch
Patch5: 0006-anaconda-fix-grub-config-setup-by-removing-non-xen-o.patch
Patch6: 0007-anaconda-make-encrypted-partitions-by-default.patch
Patch7: 0008-anaconda-set-default-grub-theme.patch
Patch8: 0009-anaconda-add-options-can_dual_boot-and-can_update-to.patch
Patch9: 0010-anaconda-efimgr-specify-root-util.getSysroot.patch
Patch10: 0011-anaconda-generate-xen-efi-configuration.patch
Patch11: 0012-anaconda-fix-dracut-module-to-work-with-reduced-depe.patch
Patch12: 0013-anaconda-use-installer-kernel-parameters-as-default-.patch
Patch13: 0014-anaconda-use-kernel-install-instead-of-grubby-to-reg.patch
#Patch14: 0015-anaconda-Fix-a-regular-expression-determining-Releas.patch
Patch15: 0016-anaconda-Do-not-fail-during-initramfs-start-up-due-t.patch
Patch16: 0017-anaconda-Disable-the-NTP-configuration-spoke.patch
Patch17: 0018-anaconda-drop-useless-on-Qubes-dependencies-on-netwo.patch
Patch18: 0019-anaconda-skip-NTP-installation-and-setup-in-dom0.patch
Patch19: 0020-anaconda-add-skip_grub-parameter-and-allow-boot-encr.patch
Patch20: 0021-anaconda-switch-default-partitioning-scheme-to-LVM-T.patch
Patch21: 0022-anaconda-add-console-none-Xen-parameter.patch
Patch22: 0023-anaconda-add-dom0_mem-min-1024M-to-default-xen-cmdli.patch
Patch23: 0024-anaconda-limit-dom0-maxmem-to-4GB-to-limit-its-overh.patch
Patch24: 0025-anaconda-disable-iommu-for-IGFX.patch
Patch25: 0026-anaconda-check-for-Qubes-OS-hardware-required-featur.patch
Patch26: 0027-anaconda-generate-proper-extlinux.conf.patch
Patch27: 0028-anaconda-don-t-crash-when-no-target-disk-is-availabl.patch
Patch28: 0029-anaconda-lock-root-account-by-default.patch
Patch29: 0030-anaconda-add-option-to-lock-root-account.patch
Patch30: 0031-anaconda-Modify-user-configuration-spoke-for-QubesOS.patch
Patch31: 0032-anaconda-Make-sure-that-a-user-is-created-at-install.patch
Patch32: 0033-anaconda-check-add-user-to-wheel-and-qubes-groups.patch
Patch33: 0034-anaconda-xen.efi-upgraded-during-each-install.patch
Patch34: 0035-anaconda-make-sure-the-latest-version-is-placed-as-x.patch
Patch35: 0036-anaconda-fix-default-scheme-in-custom-partitioning.patch
Patch36: 0037-anaconda-Fix-macOS-EFI-Installation.patch
Patch37: 0038-anaconda-use-proper-subvolume-argument-when-booting-.patch
Patch38: 0039-anaconda-enable-discard-option-for-dom0-filesystems-.patch
Patch39: 0040-anaconda-Add-ucode-scan-to-default-Xen-command-line.patch
Patch40: 0041-anaconda-avoid-adding-duplicated-kernel-entries.patch
Patch41: 0042-anaconda-mark-qubes-user-name-as-reserved.patch
Patch42: 0043-anaconda-add-smt-off-xen-option-during-installation.patch
Patch43: 0044-anaconda-update-Qubes-specific-code-for-Fedora-21-ve.patch
Patch44: 0045-anaconda-abort-installation-on-X-startup-fail.patch
Patch45: 0046-anaconda-fix-encryption-passphrase-check.patch
Patch46: 0047-anaconda-disable-os-prober.patch
